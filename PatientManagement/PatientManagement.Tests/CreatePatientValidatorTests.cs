...
public class CreatePatientValidatorTests
{
    ...
    public void Validate_ShouldReturnError_WhenDocumentTypeIsEmpty()
    {
        ...
        Assert.Contains(result.Errors, e => e.PropertyName == nameof(CreatePatientDto.DocumentType));
    }
    ...
    public void Validate_ShouldReturnError_WhenDocumentNumberIsEmpty()
    {
        ...
        Assert.False(result.IsValid);
        Assert.Contains(result.Errors, e => e.PropertyName == nameof(CreatePatientDto.DocumentNumber));
    }
    ...
    public void Validate_ShouldReturnError_WhenFirstNameIsEmpty()
    {
        ...
        Assert.False(result.IsValid);
        Assert.Contains(result.Errors, e => e.PropertyName == nameof(CreatePatientDto.FirstName));
    }
    ...
    public void Validate_ShouldReturnError_WhenLastNameIsEmpty()
    {
        ...
        Assert.False(result.IsValid);
        Assert.Contains(result.Errors, e => e.PropertyName == nameof(CreatePatientDto.LastName));
    }
    ...
    public void Validate_ShouldReturnError_WhenBirthDateIsDefault()
    {
        ...
        Assert.False(result.IsValid);
        Assert.Contains(result.Errors, e => e.PropertyName == nameof(CreatePatientDto.BirthDate));
    }
    ...
    public void Validate_ShouldReturnError_WhenPhoneNumberExceedsMaxLength()
    {
        ...
        Assert.False(result.IsValid);
        Assert.Contains(result.Errors, e => e.PropertyName == nameof(CreatePatientDto.PhoneNumber));
    }
    ...
    public void Validate_ShouldReturnError_WhenEmailIsInvalid()
    {
        ...
        Assert.False(result.IsValid);
        Assert.Contains(result.Errors, e => e.PropertyName == nameof(CreatePatientDto.Email));
    }
